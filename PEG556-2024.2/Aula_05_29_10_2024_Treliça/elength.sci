...
scale_factor = 100; // ajuste conforme necessário

// Coordenadas dos nós após a deformação (amplificadas para visualização)
...
// Desenhando as barras da estrutura deformada (amplificada)
for i = 1:6
    if i == 1 then
