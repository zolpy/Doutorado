...
node = [-2, 0, 0;   // Invertendo os valores
        -1, 0.5, 1;
        -1, 1, 0;
         0, 0, 0;
         0, 0.5, 1;
...
// Defina um valor de deslocamento para mover a estrutura para a esquerda
offset = 2; // Ajuste este valor conforme necessário
...
// Ajustando as coordenadas dos nós para mover à esquerda
p = node - offset; // Subtrai o offset das coordenadas X
...
// Ajustando também as coordenadas da estrutura deformada
plotmesh(t, pd - offset, 0, 0, 'red');    // Estrutura deformada
